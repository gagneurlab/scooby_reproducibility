...
if __name__ == '__main__' :
    ...
    pwms = read_meme(
    os.path.join('/s/project/QNA/scborzoi/submission_data', "motif_effects", "H12CORE_meme_format.meme")
    ...
    ad_alt_motif.write(os.path.join(data_path, 'motif_effects/epicardiods_motif_effects/alt_{motif_name}_multiome.h5ad'))
